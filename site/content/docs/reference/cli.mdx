...
Projects with observed page `type` values also receive an empty SEO contract
starter to adapt deliberately. See [Adopt an existing content library](/docs/guides/adoption).
