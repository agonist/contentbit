...
stats` is the read tool next to it: it analyzes documents and prints JSON to
stdout, always exiting 0 — even when documents have validation errors. It exists
so you (or your LLM agent) can rank what needs attention across a whole content
