...
block today and every [agent wired to this project](/docs/guides/agents) writes
it correctly on its next run, because skills read the registry live through the
CLI.
...
- **props** — a zod schema for the open-line props. Defaults are applied during
  ...
  describing props pays off: your agent reads those descriptions.
