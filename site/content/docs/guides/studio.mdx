...
description: Browse content health, previews, stats, links, backlinks, and keywords in a read-only local web app.
---
...
- rendered preview using `@contentbit/html`
- source Markdown
...
Generic blocks render through `@contentbit/react`. Custom blocks are still
validated from your registry, and Studio automatically looks for project
