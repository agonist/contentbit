...
If you want the full end-to-end loop, start with
[Programmatic SEO workflows](/docs/guides/programmatic-seo). This page focuses
on the config and brief mechanics.
...
Targets resolve by `key` first, then by `slug`, then by internal page id. With
