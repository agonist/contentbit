...
reports outlines, block usage, and validation summaries as JSON, so an agent can
rank what needs attention across the whole content directory.
...
clean, audit with stats. See [Coding-agent integration](/docs/guides/agents).
