 ...
 * segments and block bodies to `renderMarkdown`, and this component turns them
 * into React. This is exactly the integration documented in Guides → Plug in
 * your Markdown library — the docs themselves wire it.
 */
const components = {
