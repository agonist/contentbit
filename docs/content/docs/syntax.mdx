...
Raw HTML is disabled by default everywhere. The static HTML renderer escapes all
user content; if your project needs raw HTML, opt in at the renderer level and own
sanitization.
