...
CMSes, or LLMs — write Markdown with directive-style blocks:
...
`components` to override any of them — see [Renderers](/docs/renderers).
...
[Plug in your Markdown library](/docs/markdown).
...
- [Plug in your Markdown library](/docs/markdown)
- Learn the [block syntax](/docs/syntax)
- Define [custom blocks](/docs/custom-blocks)
- Generate [LLM authoring instructions](/docs/llm-authoring) from your registry
