...
import type { GenericHtmlStringRenderContext, MaybePromise } from '@contentbit/blocks'

import { escapeHtml, genericHtmlStringRenderers } from '@contentbit/blocks'

export type { MaybePromise } from '@contentbit/blocks'
export type AstroMarkdownRenderer = (md: string) => MaybePromise<string>

export interface AstroBlockRenderContext extends GenericHtmlStringRenderContext {
...
export const genericAstroRenderers: Record<string, AstroBlockRenderer> = genericHtmlStringRenderers
